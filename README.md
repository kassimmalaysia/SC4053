...
* [Setting Up Environment](#Environment)
  ...
  * [3. Setting up with SepoliaETH Test Net](#Ropsten)

* [Setting Up the React Front End Web Application](#FrontEnd)
* [Functionality of our  dApplication](#Navigation)
  * [1. Account](#Account)
  * [2. Bidding Information](#BiddingInformation)
  * [3.Domain For Auction](#DomainForAuction)
  * [4. Look-Up the Owner of a Domain](#OwnerOfDomain)
  * [5. Look-Up the Domain(s) of an Owner](#DomainsOfOwner)
  * [6. Send ETH to a Domain](#SendETH)
  * [7. List of Registered Domains](#ListRegisteredDomains)
...
![image](https://github.com/kassimmalaysia/SC4053/assets/101180214/bbf70994-95e3-4ec0-a19e-c4ab3d23fbfa)

Click on Deploy .During the Deployment, take note of the contract address obtained after deploying the Dns Solidity contract.
![image](https://github.com/kassimmalaysia/SC4053/assets/101180214/6b700f88-d716-4be8-84d6-2b08a6d6d992)


#### 2.2 Linking of Metamask to the Remix-EtheruemIDE
